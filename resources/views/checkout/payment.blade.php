            ...
            <div class="order-details my-5">
                ...
                <table class="table table-striped">
                    <tbody>                @php
                        ...
                        $tax = \Cart::session(Auth::user()->id)->getTotal() / 10;
...
@section('stripe')
    ...
    var stripe = Stripe('pk_test_51GzMt9JSstfUEoJ43AdOnxavwGzxstzAaQSjIkaQUkNu9I8PZqczogiPz0iGahcrahxXtINz7r9icAeXlamYMw6j00GxuHpduP');
